...
HD_PWD='D:/3.1/ProjectSCSCopy/digital-signal-filter/Project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_final.tcl
